          ...
          <div className='flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto'>
            <Link href={"/"} className='flex items-center'>
              <img
                ...
                className='h-12 mr-3 sm:h-12 drop-shadow-lg'
                alt='NextCrypt Logo'
              />
            ...
            <div className='flex items-center lg:order-2'>
              <Link
                href={"/login"}
                className='text-white bg-blue-800 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'>
                Log In
              </Link>
            </div>
          </div>
        ...
        <div className='grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28'>
          ...
          <div className='mr-auto place-self-center lg:col-span-8'>
            ...
            <p className='max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400'>
              NextCrypt is not just your average password manager. With a focus on putting user privacy first, we strive to
              put control of your data into your hands. We vow to never sell your user data to third parties. <span className="text-gray-400 dark:text-gray-300"><br/><br/>Utilizing
